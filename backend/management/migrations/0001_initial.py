# Generated by Django 5.1.4 on 2025-04-01 07:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('contact_no', models.CharField(help_text='Format: +63 9XXXXXXXXX or 09XXXXXXXXX', max_length=14, validators=[django.core.validators.RegexValidator(message='Enter a valid Philippine mobile number (e.g. +63 9XXXXXXXXX or 09XXXXXXXXX).', regex='^(?:\\+63 ?9\\d{2} ?\\d{3} ?\\d{4}|09\\d{9})$')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('customer', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='management.profile')),
                ('driver', models.ForeignKey(blank=True, limit_choices_to={'role': 'Driver'}, null=True, on_delete=django.db.models.deletion.SET_NULL, to='management.staffprofile')),
                ('order', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='delivery', to='management.order')),
            ],
        ),
        migrations.CreateModel(
            name='InventoryItem',
            fields=[
                ('item_id', models.CharField(blank=True, editable=False, max_length=10, primary_key=True, serialize=False)),
